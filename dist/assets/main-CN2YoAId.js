import{F as l}from"./Footer-D_COwTIF.js";function r(){const e=document.createElement("header");return e.className="header",e.innerHTML=`
  ...
  `,e}const n=document.querySelector(".wrapper");n&&(n.prepend(r()),n.appendChild(l()));const i=document.querySelector(".icon-menu"),d=document.querySelector(".menu__list");i.addEventListener("click",()=>{d.classList.toggle("open"),i.classList.toggle("menu-open")});document.addEventListener("DOMContentLoaded",()=>{const e=window.location.pathname;document.querySelectorAll(".menu__link").forEach(s=>{s.getAttribute("href")===e&&s.classList.add("active")})});const o=document.querySelector(".background-block"),a=document.querySelector(".header");a&&window.location.pathname=="/portier/dist/"&&(console.log("/portier/dist/"),console.log(window.location.pathname),a.classList.add("header_hidden"));const c=document.querySelector(".first-screen");o&&(o.addEventListener("animationend",e=>{if(e.animationName==="slide-top"){const t=new CustomEvent("expandBackgroundEnd",{bubbles:!0});o.dispatchEvent(t)}}),document.addEventListener("expandBackgroundEnd",()=>{a.classList.add("header_open"),c.classList.remove("first-screen_hiden"),c.classList.add("first-screen_animate")}));document.getElementById("soundButton").addEventListener("click",()=>{const e=document.getElementById("clickSound");e&&e.play().catch(t=>console.error("Ошибка воспроизведения:",t))});
